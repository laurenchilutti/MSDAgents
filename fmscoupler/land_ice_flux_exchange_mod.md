...
| cplclock_in | intent(inout) | land_ice_flux_exchange_init | is the FMS MPP clock id for the top-level coupler profiling clock; stored module-wide so that flux_land_to_ice can bracket its work. |
