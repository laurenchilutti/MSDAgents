...
| redist | integer, parameter | is a flag used to indicate grids for ocean and ice are same but with different domain decomposition. Data will be transferred with fms_mpp_redistribute. |
...
| slow_ice_ocean_pelist_in | intent(inout) | ice_ocean_flux_exchange_init | is the combined MPI pelist of the slow-ice and ocean processing element used to set module level slow_ice_ocean_pelist |
